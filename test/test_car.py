...
class TestPalindrome(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_palindrome(
            current_date=today, last_service_date=last_service_date, warning_light_on=warning_light_is_on)
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_palindrome(
            current_date=last_service_date, last_service_date=last_service_date, warning_light_on=warning_light_is_on)
